...
// last created on 2020-12-17 16:24:49 by saving form "hk-test"



/**
 * Table tl_formdata defined by form "hk-test"
 */
...
(
	...
	(
		...
		'label' => array
		(
			'fields'                  => array('date', 'form', 'alias', 'be_notes' , 'name', 'titel', 'sapt'),
	...
	<div class="fd_row field_sapt"><div class="fd_label">sapt: </div><div class="fd_value">%s </div></div>
		</div>',
			/*
			'label_callback'          => array('tl_fd_hk_test','getRowLabel')
			*/
		),
	...
	'palettes' => array
	(
		'default'                     => 'form,alias,date,ip,published,sorting;{confirmation_legend},confirmationSent,confirmationDate;{fdNotes_legend:hide},be_notes;{fdOwner_legend:hide},fd_member,fd_user,fd_member_group,fd_user_group;{fdDetails_legend},name,titel,sapt'
	),
	...
	(
		...
		'detailFields'               => array('name','titel','sapt'),
		'formFilterKey'              => 'form',
		'formFilterValue'            => 'hk-test'
	)
);
...
$GLOBALS['TL_DCA']['tl_formdata']['fields']['name']['ff_id'] = 81;
$GLOBALS['TL_DCA']['tl_formdata']['fields']['name']['f_id'] = 10;
// 'titel'
...
$GLOBALS['TL_DCA']['tl_formdata']['fields']['titel']['ff_id'] = 82;
$GLOBALS['TL_DCA']['tl_formdata']['fields']['titel']['f_id'] = 10;
// 'sapt'
$GLOBALS['TL_DCA']['tl_formdata']['fields']['sapt']['label'] = array('sapt', '[sapt] sapt');
$GLOBALS['TL_DCA']['tl_formdata']['fields']['sapt']['inputType'] = 'text';
$GLOBALS['TL_DCA']['tl_formdata']['fields']['sapt']['formfieldType'] = 'text';
$GLOBALS['TL_DCA']['tl_formdata']['fields']['sapt']['exclude'] = false;
$GLOBALS['TL_DCA']['tl_formdata']['fields']['sapt']['search'] = true;
$GLOBALS['TL_DCA']['tl_formdata']['fields']['sapt']['sorting'] = true;
$GLOBALS['TL_DCA']['tl_formdata']['fields']['sapt']['filter'] = false;
$GLOBALS['TL_DCA']['tl_formdata']['fields']['sapt']['ff_id'] = 83;
$GLOBALS['TL_DCA']['tl_formdata']['fields']['sapt']['f_id'] = 10;
 ...
 */
if (!class_exists('tl_fd_hk_test', false)) {
class tl_fd_hk_test extends \Backend
{
	...
	*/
	public function getRowLabel($arrRow)
	{
		...
		if (strlen($arrRow['sapt']))
		{
			$strRowLabel .= '<div class="fd_row field_sapt">';
			$strRowLabel .= '<div class="fd_label">' . $GLOBALS['TL_DCA']['tl_formdata']['fields']['sapt']['label'][0] . ': </div>';
			$strRowLabel .= '<div class="fd_value">' . $arrRow['sapt'] . ' </div>';
			$strRowLabel .= '</div>';
		}
		$strRowLabel .= '</div></div>';
