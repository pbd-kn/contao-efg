...
(
	...
	(
		...
		'label' => array
		(
			'fields'                  => array('date', 'form', 'alias', 'be_notes' , 'anrede', 'vorname', 'Artikelbezeichnung', 'name', 'email', 'message'),
	...
	(
		...
		'detailFields'               => array('anrede','vorname','Artikelbezeichnung','name','email','message'),
		'formFilterKey'              => 'form',
...
// 'Artikelbezeichnung'
$GLOBALS['TL_DCA']['tl_formdata']['fields']['Artikelbezeichnung']['label'] = array('Artikelbezeichnung', '[Artikelbezeichnung] ');
...
// 'message'
$GLOBALS['TL_DCA']['tl_formdata']['fields']['message']['label'] = array('ihre anfrage', '[message] ihre anfrage');
